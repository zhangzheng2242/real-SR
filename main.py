...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights-file', type=str,default='weights/12rrdb/12rrdb_gan/g_epoch_54.pth')
    parser.add_argument('--image-file', type=str, default='input-test/00003.png')
